...
def convert_onnx(net, path_module, output, opset=11, simplify=False):
    ...
    torch.onnx.export(net, img, output, input_names=["data"], output_names=["output"],
                      keep_initializers_as_inputs=False, verbose=False, export_params=True, opset_version=opset)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default="/face_data/out_combined/model.pt", help='input backbone.pth file or path')
    parser.add_argument('--output', type=str, default="./weights/face_reco_last.onnx", help='output onnx path')
